...
const AppBarWrapper = ({ appLeftNavWidth, ...other }) => (
    <AppBar {...other} />
);
...
const AppUpperNav = ({auth, selectedTickerCode, clearAuthSagaRequest, onChangeShowSelectTicker, appLeftNavWidth}) => {
    ...
    const selectedTicker = tickerList.find(elem => elem.code === selectedTickerCode);
