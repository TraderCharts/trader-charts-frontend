...
const LinearRegressionChannelIcon = (props) => (
...
LinearRegressionChannelIcon.displayName = "LinearRegressionChannelIcon";
LinearRegressionChannelIcon.muiName = "SvgIcon";

export default LinearRegressionChannelIcon;
